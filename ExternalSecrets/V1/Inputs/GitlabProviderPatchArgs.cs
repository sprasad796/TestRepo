...
namespace Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1
{
    ...
    {
        [Input("auth")]
        public Input<Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1.GitlabProviderAuthPatchArgs>? Auth { get; set; }
        ...
        [Input("caProvider")]
        public Input<Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1.GitlabProviderCaProviderPatchArgs>? CaProvider { get; set; }
