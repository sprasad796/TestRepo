...
namespace Pulumi.Kubernetes.Types.Outputs.ExternalSecrets.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterExternalSecretSpecExternalSecretSpecDataFromRewriteMerge
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterExternalSecretSpecExternalSecretSpecDataFromRewriteMerge(
