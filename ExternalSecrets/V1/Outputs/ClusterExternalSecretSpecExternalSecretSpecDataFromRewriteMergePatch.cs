...
namespace Pulumi.Kubernetes.Types.Outputs.ExternalSecrets.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterExternalSecretSpecExternalSecretSpecDataFromRewriteMergePatch
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterExternalSecretSpecExternalSecretSpecDataFromRewriteMergePatch(
