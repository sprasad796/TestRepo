...
namespace Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1
{
    ...
    /// </summary>
    public class GitlabProviderPatchArgs : global::Pulumi.ResourceArgs
    {
        [Input("auth")]
        public Input<Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1.GitlabProviderAuthPatchArgs>? Auth { get; set; }
        ...
        [Input("caProvider")]
        public Input<Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1.GitlabProviderCaProviderPatchArgs>? CaProvider { get; set; }
        ...
        public GitlabProviderPatchArgs()
        {
        }
        public static new GitlabProviderPatchArgs Empty => new GitlabProviderPatchArgs();
    }
}
