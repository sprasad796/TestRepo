...
namespace Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1
{
    ...
    {
        [Input("auth")]
        public Input<Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1.GitlabProviderAuthArgs>? Auth { get; set; }
        ...
        [Input("caProvider")]
        public Input<Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1.GitlabProviderCaProviderArgs>? CaProvider { get; set; }
