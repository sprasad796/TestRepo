...
namespace Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1
{
    ...
    /// </summary>
    public class OnboardbaseProviderArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("auth")]
        public Input<Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1.OnboardbaseProviderAuthArgs>? Auth { get; set; }
        ...
        public OnboardbaseProviderArgs()
        {
        }
        public static new OnboardbaseProviderArgs Empty => new OnboardbaseProviderArgs();
    }
}
