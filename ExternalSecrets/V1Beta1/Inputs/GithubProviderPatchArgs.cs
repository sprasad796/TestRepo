...
namespace Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1
{
    ...
    /// </summary>
    public class GithubProviderPatchArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("auth")]
        public Input<Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1.GithubProviderAuthPatchArgs>? Auth { get; set; }
        ...
        public GithubProviderPatchArgs()
        {
        }
        public static new GithubProviderPatchArgs Empty => new GithubProviderPatchArgs();
    }
}
