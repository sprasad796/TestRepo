...
namespace Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1
{
    ...
    /// </summary>
    public class PulumiProviderArgs : global::Pulumi.ResourceArgs
    {
        [Input("accessToken")]
        public Input<Pulumi.Kubernetes.Types.Inputs.ExternalSecrets.V1Beta1.PulumiProviderAccessTokenArgs>? AccessToken { get; set; }
        ...
        public PulumiProviderArgs()
        {
        }
        public static new PulumiProviderArgs Empty => new PulumiProviderArgs();
    }
}
