...
namespace Pulumi.Kubernetes.Types.Outputs.ExternalSecrets.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class PulumiProviderPatch
    {
        public readonly Pulumi.Kubernetes.Types.Outputs.ExternalSecrets.V1Beta1.PulumiProviderAccessTokenPatch AccessToken;
        /// <summary>
        ...
        [OutputConstructor]
        private PulumiProviderPatch(
            Pulumi.Kubernetes.Types.Outputs.ExternalSecrets.V1Beta1.PulumiProviderAccessTokenPatch accessToken,
